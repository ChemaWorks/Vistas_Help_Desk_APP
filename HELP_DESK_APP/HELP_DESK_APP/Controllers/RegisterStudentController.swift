...
class RegisterStudentController: UIViewController {
    ...
    @IBAction func registrarAlumno(_ sender: Any) {
        ...
        let nuevoAlumno = Usuario(nombre: nombre, apellido: apellido, correo: correo, tipo: "Alumno", contraseña: contraseña)
